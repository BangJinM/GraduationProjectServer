...
public class ConnectionPool {
	    ...
	    public static ConnectionPool GetPoolInstance(){  
	        if(poolInstance == null) {  
	            ...
	            poolInstance = new ConnectionPool(                     
	                    ...
	                    "jdbc:mysql://localhost:3306/PlayerAccountInfo?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&useSSL=false",                
	                    "root", "root");  
	            try {  
	    ...
	    public void setInitialConnections(int initialConnections) {  
	        this.DEFAULTCONNECTIONS = initialConnections;  
	    }  
	    /** 
	     * 返回连接池自动增加的大小 、 
	     *  
